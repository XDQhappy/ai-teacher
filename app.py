        ...
        if grades:
            ...
            for idx, grade in enumerate(grades):
                with cols[idx]:
                    ...
                    st.image(img_path, caption=grade, width=150)
...
# ======================
    ...
    if st.button("⬅️ 返回选择科目/年级"):
        st.session_state["page"] = "subject"
        st.session_state.pop("lesson_text", None)  # 可选：清除已生成教案
    ...
    with col2:
        ...
        with st.form(key="socratic_form_top"):
            user_question = st.text_input("向AI提问", placeholder="在此输入问题...", key="user_question_top")
